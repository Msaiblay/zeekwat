...
<div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <img class="navbar-brand brand-logo"  src="{{asset('frontend/images/zeekwatlogo2.png')}}" alt="logo" />
            <div class="navbar-brand brand-logo-mini"><img  src="{{asset('frontend/images/zeekwatlogomini.png')}}" alt="logo" /></div>
        </div>
...
<script >
    $(document).ready(function() {
        ...
        $('#multi-filter-select').DataTable( {
            ...
            initComplete: function () {
                this.api().columns().every( function () {
                    var column = this;
                    var select = $('<select class="d-inline-block"><option value=""></option></select>')
        ...
        var action = '<td> <div class="form-button-action ml-auto"> <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"> <i class="fa fa-edit"></i> </button> <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove"> <i class="fa fa-times"></i> </button> </div> </td>';
