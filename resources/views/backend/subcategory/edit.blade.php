					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								...
								<a class="btn btn-outline-primary btn-round ms-auto" href="{{ route('subcategories.index') }}">
						...
						<form action="{{ route('subcategories.update',$subcategories->id) }}" method="POST">
							...
							<div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      	<input type="text" class="form-control @error('name')is-invalid @enderror" id="name_id" name="name" value="{{ $subcategories->name }}">
