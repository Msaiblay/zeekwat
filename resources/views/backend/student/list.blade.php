                    ...
                    <table id="add-row" class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <a href="{{route('students.edit',$id)}}" class="btn btn-rounded btn-gradient-warning">
                                Edit
                               </a>


                            <form class="d-inline-block" action="{{route ('students.destroy',$id)}}" method="POST" onsubmit="return confirm('Are you sure want to delete?')">
                                @csrf
                                @method('DELETE')
